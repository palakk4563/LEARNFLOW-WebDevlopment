...
export declare class StreamChat<StreamChatGenerics extends ExtendableGenerics = DefaultGenerics> {
    ...
    */
     ...
     */
    createUserSegment(id: string, name: string, data?: SegmentData): Promise<{
     ...
     * @return {Segment} The created Segment
     */
    createChannelSegment(id: string, name: string, data?: SegmentData): Promise<{
        segment: SegmentResponse;
    }>;
    ...
    startCampaign(id: string, scheduledFor?: string): Promise<{
        campaign: CampaignResponse;
    } & APIResponse>;
    /**
     ...
     */
    stopCampaign(id: string): Promise<CampaignResponse>;
    /**
